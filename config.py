...
DELETE_EMPLOYEE_SELECT = 17
SELECT_EMPLOYEE_FOR_MATERIAL = 18
SELECT_MATERIAL_ACTION = 19
ENTER_FIBER_AMOUNT = 20
ENTER_TWISTED_AMOUNT = 21
SELECT_EMPLOYEE_FOR_ROUTER = 22
SELECT_ROUTER_ACTION = 23
ENTER_ROUTER_NAME = 24
ENTER_ROUTER_QUANTITY = 25

# Отчеты
SELECT_REPORT_EMPLOYEE = 26
SELECT_REPORT_PERIOD = 27
